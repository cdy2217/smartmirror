...
void HandGesture::computeFingerNumber(){
	...
	facehistory[4] = facehistory[3];
	facehistory[3] = facehistory[2];
	...
	facehistory[0] = mostFrequentFingerNumber;
	if( (facehistory[0] == facehistory[1])  &&( facehistory[1] == facehistory[2]) &&( facehistory[2]==facehistory[0])&& (facehistory[4]==facehistory[3]) && (facehistory[3] == facehistory[2]) )
            	 {
                           htmlget(mostFrequentFingerNumber);
		shut = shut+1;
		facehistory[0] = 11;
                facehistory[1] = 12;
                facehistory[2] = 13;
